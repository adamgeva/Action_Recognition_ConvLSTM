...
from utils.utils_video import get_clip_meta, skip_first_frames
import cv2

os.system("ls -l")

vid_in = '/hdd/UCF-ARG/aerial_clips/jogging/person07_01_aerial_jogging.avi'
vid_out = '/hdd/test1.avi'
start_frame = 50
example_size = 40
new_width = 150
new_height = 150
...
write_movie(vid_in, vid_out, start_frame)
